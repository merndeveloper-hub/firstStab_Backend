...
const getReviews = async (req, res) => {
  try {
    ...
    const getUserReview = await getAggregate("review", [
  ...
  bookingRequestTime: 1,
        ...
        },
        {
          $lookup: {
            ...
            let: { proServiceId: { $toObjectId: "$proServiceId" } }, // Extract professsionalId
            pipeline: [
              {
                $match: {
