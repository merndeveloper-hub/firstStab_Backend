...
const sendCheckrInvitation = async (candidate_id, findUser, bgPackage) => {
  const inviteData = {
    ...
    redirect_url: "http://localhost:5000/api/v1/pro/payment/paypalcancel" // Deep link handled in React Native
  };
...
const createCandidatesCertn = async (
  id,
  bgServiceName,
  bgValidation,
  serviceCountry,
...
export default createCandidatesCertn;
