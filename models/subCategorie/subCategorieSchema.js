...
const subCategorySchema = new mongoose.Schema({
 ...
 // fixed_price: { type: schemaType.TypeString, required: true },
  ...
  fixed_price: { type: schemaType.TypeString, required: true },
  min_price: { type: schemaType.TypeString, required: true },
  max_price: { type: schemaType.TypeString, required: true },
  ...
  serviceCountry: { type: schemaType.TypeString, enum: ['US', 'NON-US','Both'], default: 'US' },
   bgServiceName: { type: schemaType.TypeString, enum: ['checkr', 'certn','Both'], default: 'checkr' },
